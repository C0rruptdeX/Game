...
function setNewLevel() {
  ...
  if(game.level.loadetLevel == 0) {
    ...
    game.level.walls_info =  [4780, 4900, 20, 300,   4800, 4900, 200, 20,   4780, 5200, 120, 20,    4900, 5100, 20, 120,   4900, 5100, 100, 20,   4980, 5100, 20, 120,   4980, 5200, 120, 20,
  	...
  	game.level.floor_info = [6151,4501, 500, 750,    4781, 4901, 530, 200,   4801, 4601, 500, 200,   4781, 5001, 130, 200,   4981, 5001, 130, 200,   5181, 5001, 130, 200,   4981, 4801, 130, 200,];
    ...
    game.level.magie_info = [5240, 4550, 100, 100,];
  	...
  	game.level.doors_steel_info = [5000, 5090, 100, 30, 0, 0,    5000, 4890, 100, 30, 1, 0,    5000, 4810, 100, 30, 2, 2,    4945, 4620, 30, 100, 3, 4,    6490,4670, 20, 100, 2, 5,];
