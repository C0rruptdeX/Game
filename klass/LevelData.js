...
function setNewLevel() {
  ...
  if(game.level.loadetLevel == 2) {
    game.level.walls_info =  [4900, 5100, 270, 20,   4900, 4850, 20, 270,   5150, 4850, 20, 260,   5040, 4850, 270, 20,   4920, 4850, 40, 20,
                              ...
                              6800, 4330, 120, 20,   6900, 4330, 20, 170,   6640, 4451, 20, 120,   6640, 4340, 20, 30,];
  	...
  	game.level.keys_steel_info = [];
  	game.level.button_info = [5135, 4730, 1, 2,   6830, 4690, 3, 3,    6590, 4620, 3, 4,];
  	...
  	game.level.telebs_info = [];
  	game.level.teleps_info = [5100, 4930, 6500, 4970,    6495, 4380,];
